...
main (void)
{
   ...
   double     point_out;          /* Buffer to read scalar attribute back */

   /*
    * Data initialization.
    */
   int vector[] = {1, 2, 3, 4, 5, 6, 7};  /* Dataset data */
   double point = 1;                         /* Value of the scalar attribute */
   ...
   attr2 = H5Acreate2(dataset, "Integer attribute", H5T_NATIVE_DOUBLE, aid2,
                     H5P_DEFAULT, H5P_DEFAULT);

   /*
    * Write scalar attribute.
    */
   ret = H5Awrite(attr2, H5T_NATIVE_DOUBLE, &point);
   ...
   ret  = H5Aread(attr, H5T_NATIVE_DOUBLE, &point_out);
